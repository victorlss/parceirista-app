  ...
  return (
    <View style={styles.containerWrapper}>
      ...
      <View style={styles.buttonsWrapper}>
        <MediumButton text="Dados Pessoais" isActive={isDadosPessoais} onPress={() => setIsDadosPessoais(true)} />
        <MediumButton text="Dados Bancarios" isActive={!isDadosPessoais} onPress={() => setIsDadosPessoais(false)} />
      </View>
